class GameState:
    def __init__(self, configuration: str, parent=None, movement_cost=0, heuristic_cost=0):
    ...
    @staticmethod
    # check if the blank tile can be swapped with a certain tile
    ...
    # returns all the reachable states
